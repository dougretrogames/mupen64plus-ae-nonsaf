...
10. **Estabilidade com Frontends**: Restauração do modo de lançamento (`launchMode`) original e correção da lógica de monitoramento do processo de emulação. Isso resolve problemas de fechamento repentino ou falha ao trocar de jogo quando o emulador é iniciado por frontends externos (como ARC Browser, DIG, Pegasus ou LaunchBox), especialmente em dispositivos com Android 7.0 ou inferior.
