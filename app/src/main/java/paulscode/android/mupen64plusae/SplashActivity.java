...
public class SplashActivity extends AppCompatActivity implements ExtractAssetsListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Inicia o fluxo de permissões focado em armazenamento (Android 10 e anterior)
        requestPermissions();
    }

    private void requestPermissions() {
        // No Android 10 (API 29) ou inferior, precisamos de permissão de escrita e leitura explicitamente
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_REQUEST) {
            ...
            if (!granted) {
                // Se negado, encerra o app pois os assets não podem ser extraídos sem acesso ao disco
    ...
    private void createChannel() {
        // Lógica de canais para Android TV (Preview Channels)
        ...
        try {
            ...
            Log.e("SplashActivity", "Erro ao criar canal: " + e.getMessage());
        }
    }
}
